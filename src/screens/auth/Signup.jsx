  ...
  return (
    <div style={{ minHeight: "100%", background: "#f8f8f6", padding: "50px 28px 40px", overflowY: "auto" }}>
      ...
      <div style={{ marginBottom: "6px" }}>
        ...
        <input placeholder="Min 8 chars, uppercase, number, special" type="password" value={signupPassword}
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: "6px", marginBottom: "14px", marginTop: "-6px" }}>
          {[
      ...
      <div style={{ display: "flex", gap: "10px", marginBottom: "20px" }}>
        {[
          ...
          <div key={item.role} onClick={() => setSelectedRole(item.role)} style={{
            flex: 1, padding: "14px 10px", borderRadius: "16px", cursor: "pointer", textAlign: "center",
    ...
    <div style={{ minHeight: "100%", background: "#f8f8f6", padding: "60px 28px", textAlign: "center" }}>
      ...
      {[
        ...
        <div key={item.role} onClick={() => handleSelectRole(item.role)}
          style={{
            background: "#fff", borderRadius: "20px", padding: "20px", marginBottom: "14px",
            cursor: "pointer", textAlign: "left", display: "flex", gap: "16px", alignItems: "center",
            boxShadow: "0 4px 20px rgba(0,0,0,0.07)", border: "1.5px solid #f0f0f0",
          }}>
